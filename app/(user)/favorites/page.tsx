          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex items-center space-x-6">
                ...
                <Link href="/books" className="text-slate-600 dark:text-slate-400 font-semibold hover:text-emerald-700 dark:hover:text-emerald-400">
                  Browse Books
                </Link>
                <Link href="/favorites" className="text-emerald-600 dark:text-emerald-400 hover:text-slate-900 dark:hover:text-white font-medium">
                  My Favorites
                </Link>
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-xs text-slate-500 dark:text-slate-400">
                      ...
                      <span className="text-xs text-slate-500 dark:text-slate-400">
                        {favorite.book._count.reviews} reviews
                      </span>
                    </span>
                  </div>
                  ...
                  <Link
                    ...
                    className="block w-full py-2 bg-emerald-600 text-white rounded-lg font-semibold text-center hover:bg-emerald-700 transition-colors"
                  >
                    Read Summary
                  </Link>
                </div>
